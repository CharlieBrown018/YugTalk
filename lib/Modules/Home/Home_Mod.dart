...
import '../Activity Mode/ActivityMode_Mod.dart';
import '../Activity Mode/Statistics/Stats_Mod.dart';
import '../Activity Mode/Statistics/WordUsage.dart';
import 'MeMode_widget.dart';
      ...
      switch (_tabController.index) {
        case 0:
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const MeMode_Widget()));
          break;
        case 1:
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const MeMode_Widget()));
                      },
